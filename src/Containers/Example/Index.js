...
import { Fonts, Gutters, Layout, Colors, ColorsDarkMode, Svgs } from '@/Theme';
...
const Home = (props) => {
  ...
  function DrawerContent() {
    return (
      <Drawer.Section>
        <Drawer.Item label="Game" active={false} />
        <View
          style={{
        ...
        />
        <Drawer.Item label="Profile" active={false} />
      </Drawer.Section>
    );
  }
